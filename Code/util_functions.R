...
# Square function
# adapted from HBC Training Intro to R lesson (put URL here)
# and the well-known R-bloggers website (put URL here)
...
# Anscombe's quartet
# Example from R-bloggers website (put URL here)
anscombes_quartet <- {
    library(Tmisc)
